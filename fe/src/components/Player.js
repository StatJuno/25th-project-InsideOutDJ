            ...
            <div className="max-h-[600px] w-full overflow-hidden z-20">
              ...
              <div className={text_400}>
                <Marquee
                  speed={25}
                  pauseOnHover={true}
                  className="text-6xl font-bold italic mt-2 tb-3 subpixel-antialiased drop-shadow-[0_4px_4px_rgb(45, 212, 191)]"
                >
                  #트로트 #CCM #힙합 #레게 #클래식 #포크 음악 #컨트리 뮤직
                  #일렉트로닉 뮤직 #블루스 #재즈 #팝 #록 음악 #발라드 #디스코
                  #로큰롤 #전자 음악&nbsp;
                </Marquee>
              </div>
              <div className={text_300}>
                <Marquee
                  speed={25}
                  pauseOnHover={true}
                  className="text-6xl font-bold italic mt-3 tb-2 subpixel-antialiased"
                >
                  #블루스 #일렉트로닉 뮤직 #트로트 #클래식 #록 음악 #발라드
                  #디스코 #재즈 #로큰롤 #CCM #레게 #전자 음악 #힙합 #팝 #포크
                  음악 #컨트리 뮤직&nbsp;
                </Marquee>
              </div>
              <div className={text_300}>
                <Marquee
                  speed={25}
                  pauseOnHover={true}
                  className="text-6xl font-bold italic mt-2 tb-3 subpixel-antialiased"
                >
                  #레게 #발라드 #록 음악 #컨트리 뮤직 #블루스 #힙합 #전자 음악
                  #CCM #클래식 #포크 음악 #트로트 #일렉트로닉 뮤직 #팝 #로큰롤
                  #재즈 #디스코&nbsp;
                </Marquee>
              </div>
            </div>
