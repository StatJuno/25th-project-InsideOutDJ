...
BATCH_SIZE = 16
EPOCHS = 3
OUTPUT_DIR_VALENCE = "MyGit/valence_model"
OUTPUT_DIR_AROUSAL = "MyGit/arousal_model"
WARMUP_STEPS = 500
WEIGHT_DECAY = 0.01
...
# 데이터 로드 및 토크나이저 설정
# -------------------------------
df = pd.read_csv("MyGit/감정데이터_v3.csv")
...
columns_to_remove_valence = ["Unnamed: 0", "__index_level_0__", "sentence", "arousal"]
...
columns_to_remove_arousal = ["Unnamed: 0", "__index_level_0__", "sentence", "valence"]
